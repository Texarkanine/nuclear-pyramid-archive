<html>
<head>
<meta name="description" content="An article about the 2nd and 3rd pyramids at Giza after the Great Pyramid. It is proposed that the Great Pyramid is a plutonium mill; this article expands on the purposes of the other pyramids..">
<meta name="keywords" lang="en" content="pyramid, second, third, giza, egypt, nuclear, plutonium">
...
<h1>The Other Two Pyramids at Giza</h1><br>

<i>
<b>Abstract:</b>
The premise that the Great Pyramid was a plutonium mill is briefly reviewed. The practical uses of the plutonium are examined. The internal geometries of the second and third pyramids are related to the known fabrication and assembly steps of making nuclear fission thermal engine cores.
</i>

The speculation that the Great Pyramid at Giza was a nuclear mill for breeding and then extracting plutonium was presented in Great Pyramid at Giza in the September 2001, Meta Research Bulletin. Based upon additional reflection and analysis, it is now proposed that the Second Pyramid and Third Pyramid were also engaged in the same enterprise.
...
<center>
<img src="./greatpyramid/fig002.gif"></center><br><br>

The fabrication of plutonium into useful forms for a bomb, or a nuclear module for an engine requires the following steps:

<ul>
<li>Melting plutonium buttons.
<li>Pouring the melt into molds.
<li>Removing the plutonium from the molds.
<li>Machining the molded plutonium to achieve exact dimensions for plutonium parts.
<li>Tack welding plutonium parts together to form larger geometric structures.
</ul>

In all of the above steps, there must be:

<ul>
<li>Protection against criticalities.
<li>Protection of the workers from expected radiation.
<li>Protection against fires.
<li>Good geometric separation of the various steps so that any one accident would endanger as few steps of the process as possible.
<li>A means for workers to suit up before operations and a way to decontaminate after operations.
</ul>

These steps and protections can be addressed by the internal geometry of the Second Pyramid:

<ul>
<li>The Upper Entrance and Upper Descending Passage would allow for lowering the plutonium wagon into the Second Pyramid.
<li>The level corridor gives good distance to the Burial Chamber.
<li>The massive granite sarcophagus provides a stable, long lasting chamber for melting and casting plutonium. Limestone blocks would disintegrate, giving off carbon dioxide and leaving calcium oxide dust, under such high, radiant temperature.
<li>The cooled plutonium moldings would be brought by heavy wagon, out of the Burial Chamber, along the level corridor, down to the lower corridor, and then into the Subsidiary Chamber.
<li>The machining and tack welding of plutonium parts would have been done in the Subsidiary Chamber in a stretched out, assembly line fashion.
<li>The parts would have been loaded in a heavy wagon and taken out via the Upper Descending Passage and out the Upper Entrance.
<li>Workers would have entered and exited the pyramid by the Lower Entrance and Lower Descending Passage. This route would have been kept radiation free.
<li>The offset area close to the Subsidiary Chamber would be the logical position for protective suits and for decontamination.
</ul>
...
<center>
<img src="./greatpyramid/fig003.gif"></center><br><br>
...
<h2><i>Appendix.</i>
Methodologies for Scientific Proof of Plutonium Processing in the 2<super>nd</super> and 3<super>rd</super> Pyramids</h2>
